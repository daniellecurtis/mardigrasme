...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post riders_url, params: { rider: { float: @rider.float, level: @rider.level, parade: @rider.parade, position: @rider.position, side: @rider.side, userid: @rider.userid } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { float: @rider.float, level: @rider.level, parade: @rider.parade, position: @rider.position, side: @rider.side, userid: @rider.userid } }
